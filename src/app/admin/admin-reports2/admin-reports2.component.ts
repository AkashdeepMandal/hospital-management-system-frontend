...
export class AdminReports2Component implements OnInit {
  ...
  displayedColumns: string[] = ['patientRegistrationNumber','patientFirstName','patientLastName','patientGender','patientAddress','patientCity','patientDistrict','patientAadhar','patientDOB','patientmaritalStatus','patientContact','patientemail','guardianName','guardianGender','guardianAadhar','guardianContact'];
  dataSource = null;
  ...
  searchPatient(keyupevent:KeyboardEvent){
   ...
   generateReport(patient:any){
    ...
    doc.text("Aadhar : "+patient.Aadhar,x,y+=gap);
    ...
    if(patient.guardian.guardianType!="Self"){
      ...
      doc.text("Aadhar : "+patient.guardian.Aadhar,x,y+=gap);
    }
    doc.setFontStyle("italic");
    doc.setFontSize(10);
    doc.setTextColor(100);
