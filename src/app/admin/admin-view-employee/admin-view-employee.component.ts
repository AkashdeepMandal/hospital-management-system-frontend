...
export class AdminViewEmployeeComponent implements OnInit {
  ...
  a=""
  b=[{},{}]
  displayedColumns: string[] = ['employeeRegistrationNumber','employeeFirstName','employeeLastName','employeeGender','employeeAddress','employeeCity','employeeDistrict','employeeAadhar','employeemaritalStatus','employeeContact','employeeemail','employeeType','highestEducation'];
  emloyeeSource=null;
